  ...
  const onSubmit: SubmitHandler<Schema> = async (data) => {
    ...
    try {
      ...
      if (error.response && error.response.status === 400) {
        (Object.keys(error.response.data) as Array<keyof Schema>).forEach(
          (field) => {
                        ...
                        >
                          ...
                          <div className="mt-2 mb-3.5">
                            ...
                            <div className="flex items-center">
                              <input
                                className="flex-grow rounded border border-stroke bg-gray py-2 pl-4.5 pr-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
                                type="text"
