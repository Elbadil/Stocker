  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(() => {
      setSeconds((prevSeconds) => {
        if (prevSeconds <= 1) {
          emailCounter >= 3 ? setEmailSent(true) : setEmailSent(false);
              ...
              <form onSubmit={submitForm}>
                ...
                <div className="mt-5 mb-3">
                  {emailSent ? (
                    <button
                      type="submit"
                      className="w-full rounded-lg border p-4 cursor-not-allowed bg-blue-400 text-white"
                      disabled={true}
                    >
                      {emailCounter <= 2
