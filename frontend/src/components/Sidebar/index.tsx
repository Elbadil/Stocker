  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-4.5 lg:py-5.5">
        <NavLink to="/">
          <img className="ml-2 w-49" src={Logo} alt="Logo" />
        </NavLink>
        <button
          ref={trigger}
        ...
        <nav className="mt-5 py-2 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item: Client Orders -->  */}
              <SidebarLinkGroup
                activeCondition={pathname.includes('client_orders')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-3 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {/* <!-- Menu Item: Supplier Orders -->  */}
              <SidebarLinkGroup
                activeCondition={pathname.includes('supplier_orders')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
